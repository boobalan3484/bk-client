        ...
        <section id='about' className="py-14 pt-20" >
            <div className="max-w-screen-xl mx-auto md:px-8">
                <div className="items-center gap-x-10 sm:px-4 md:px-0 lg:flex">
                    <div className="flex-1 block sm:hidden lg:block"
                        data-aos="fade-up"
                    >
                        <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" className="md:max-w-lg sm:rounded-lg px-4 md:px-0" alt="" />
                    </div>
